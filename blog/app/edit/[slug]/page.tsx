...
function CreateBlogPage() {
    ...
    const slug = searchParams.slug; // Get post ID from URL query params
        ...
        if (slug) {
            const fetchPost = async () => {
                try {
                    ...
                    const response = await fetch(`/api/blog/findbyid/${slug}`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`/api/blog/edit`, {
                ...
                body: JSON.stringify({post:post,id:slug}),
            });
            ...
            setError('Failed to create edit post. Please try again.');
            console.error(err);
        } finally {
            setIsSubmitting(false);
        }
